...
KNOWN_PUBLISH_DATE_TAGS = [
    ...
    {'attribute':'class', 'value':'published-date', 'content': 'text'},
    {'attribute':'pubdate','value':'','content':'datetime'},
    {'attribute':'class','value':'date','content':'datetime'}
]
